  ...
  useEffect(() => {
    ...
    const data = {
      nodes: [
        ...
        { id: "NLP", group: 2 },
        { id: "Software Development", group: 3 },
        { id: "Domain Knowledge", group: 4 },
        { id: "Product", group: 4 },
        { id: "Marketing", group: 4 },
        { id: "Operations", group: 4 },
      ],
      links: [
        { source: "I'm here!", target: "Data Analytics" },
        { source: "I'm here!", target: "Machine Learning" },
        { source: "I'm here!", target: "Software Development" },
        { source: "I'm here!", target: "Domain Knowledge" },
        { source: "Data Analytics", target: "Business Intelligence" },
        ...
        { source: "Machine Learning", target: "Domain Knowledge" },
