  ...
  useEffect(() => {
    const data = {
      nodes: [
        ...
        { id: "A / B Testing", group: 1 },
        { id: "Machine Learning", group: 1 },
        { id: "NLP", group: 1 }, 
        { id: "Python | R | SQL", group: 1 },
        { id: "Domain Knowledge", group: 3, x: 0, y: -100 },
      ...
      links: [
        ...
        { source: "Data Science", target: "A / B Testing" },
        { source: "Data Science", target: "Machine Learning" },
        { source: "Data Science", target: "Python | R | SQL" },
